...
ferryboat.initializeBeacon = function(options) {
    ...
    console.log("Initializing Hrbr Beacon Driver");
...
ferryboat.initializeGrok = function (beaconOpts, pattern, custom, extra) {
    ...
    if (pattern) {
        console.log("Initializing Grok filter");
        ...
        if (extra) {
            ...
            if (files && files.length) {
                console.log("Reading patterns from %s", extra);
        ...
        if (custom) {
            ...
            if (files && files.length) {
                console.log("Reading patterns from %s", custom);
